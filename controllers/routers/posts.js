...
posts.posts.show = {
  alias: async function posts_post_show_alias(req, res) {                                                                                          // tofix: revise alias behavior (merged into `postHandler`)
  ...
  GET: async function posts_post_show_GET(req, res, next) {                                                                                      // tofix: post not found page
