...
} = require(`${__ROOT__}/controllers/modules/upload/handlers`)[Symbol.for('__TEST__')];


// modules
const helpers = require(`${__ROOT__}/controllers/modules/upload/helpers`);
...
// mocks
jest.mock(`${__ROOT__}/controllers/modules/upload/helpers`);
jest.mock('fs', () => ({
  unlink: jest.fn(),
}));
