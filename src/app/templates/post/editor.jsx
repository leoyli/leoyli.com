...
// components
const Editor = ({ onSubmit, isSubmittable, post: { title, featured, category, tags, time, content } = {} }) => (
  <form autoComplete="off" className="container d-flex pt-3 _-form" onSubmit={onSubmit}>
    <div className="form-row">
      ...
      <div className="_-form__row d-inline-flex">
        ...
        <button className="col-2" disabled={!isSubmittable}>{title ? 'UPDATE' : 'SUBMIT'}</button>
      </div>
    </div>
  </form>
);
