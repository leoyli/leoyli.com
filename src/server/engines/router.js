...
const { exportHTML, exportJSON, rendererSymbols } = require('../controllers/handlers/exporter');
const { initialReceptor, browserReceptor, APIReceptor } = require('../controllers/handlers/receptor');
